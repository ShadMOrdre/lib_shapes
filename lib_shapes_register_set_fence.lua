...
lib_shapes.register_fence_node = function(node_mat, shape)
...
lib_shapes.register_fence_set = function(node_mat)

	lib_shapes.register_fence_node(node_mat, "fence")
	lib_shapes.register_fence_node(node_mat, "fence_stone_cobble_post")

	lib_shapes.register_fence_node(node_mat, "rail")
	lib_shapes.register_fence_node(node_mat, "rail_post")
