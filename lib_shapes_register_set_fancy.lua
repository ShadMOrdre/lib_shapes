...
lib_shapes.register_fancy_node = function(node_mat, shape)
...
lib_shapes.register_fancy_set = function(node_mat)

	lib_shapes.register_fancy_node(node_mat, "column_base_100_height_100_width")
	lib_shapes.register_fancy_node(node_mat, "column_base_050_height_100_width")
	lib_shapes.register_fancy_node(node_mat, "column_beam")
	lib_shapes.register_fancy_node(node_mat, "column_beam_with_support")
	lib_shapes.register_fancy_node(node_mat, "column_pillar_075_width")
	lib_shapes.register_fancy_node(node_mat, "column_pillar_050_width")
	lib_shapes.register_fancy_node(node_mat, "column_pillar_with_slab_100_height_050_width")
	lib_shapes.register_fancy_node(node_mat, "column_pillar_with_full_wall_075_width")
	lib_shapes.register_fancy_node(node_mat, "column_pillar_with_full_wall_050_width")

	lib_shapes.register_fancy_node(node_mat, "steps_open_basic_01")
	lib_shapes.register_fancy_node(node_mat, "steps_solid_basic_01")

	lib_shapes.register_fancy_node(node_mat, "wall_100_height_075_width")
	lib_shapes.register_fancy_node(node_mat, "wall_100_height_050_width")
	lib_shapes.register_fancy_node(node_mat, "wall_100_height_025_width")
	lib_shapes.register_fancy_node(node_mat, "wall_100_height_0125_width")
	lib_shapes.register_fancy_node(node_mat, "wall_junction_with_slab_100_height_050_width")
	lib_shapes.register_fancy_node(node_mat, "wall_with_slab_100_height_050_width")
	lib_shapes.register_fancy_node(node_mat, "wall_with_deco_01_100_height_050_width")
	lib_shapes.register_fancy_node(node_mat, "wall_arch_large_100_height_050_width")
	lib_shapes.register_fancy_node(node_mat, "wall_arch_small_100_height_050_width")
