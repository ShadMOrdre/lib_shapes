...
lib_shapes.register_shape("wall_100_height_0125_width", {
...
lib_shapes.register_shape("wall_arch_large_100_height_050_width", {
	description = "wall_arch_large_100_height_050_width", 
	shape_type = "basic",
	node_box = {
			type = "fixed",
			fixed = {
...
lib_shapes.register_shape("wall_arch_small_100_height_050_width", {
	description = "wall_arch_small_100_height_050_width", 
	shape_type = "basic",
	node_box = {
		type = "fixed",
		fixed = {
