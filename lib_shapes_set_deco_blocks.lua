...
lib_shapes.register_shape("geometric_stone_01_100_height_100_width", {
...
lib_shapes.register_shape("geometric_stone_02_100_height_100_width", {
	description = "Column Base Half Height Full Width", 
	shape_type = "basic",
	node_box = {
		type = "fixed",
...
lib_shapes.register_shape("geometric_stone_03_100_height_100_width", {
	description = "Column Base Half Height Full Width", 
	shape_type = "basic",
	node_box = {
		type = "fixed",
...
lib_shapes.register_shape("geometric_stone_04_100_height_100_width", {
	description = "Column Base Half Height Full Width", 
	shape_type = "basic",
	node_box = {
		type = "fixed",
...
lib_shapes.register_shape("geometric_stone_05_100_height_100_width", {
	description = "Column Base Half Height Full Width", 
	shape_type = "basic",
	node_box = {
		type = "fixed",
...
lib_shapes.register_shape("geometric_stone_06_100_height_100_width", {
	description = "Column Base Half Height Full Width", 
	shape_type = "basic",
	node_box = {
		type = "fixed",
...
lib_shapes.register_shape("stone_embossed_01_100_height_100_width", {
	description = "Column Base Half Height Full Width", 
	shape_type = "basic",
	node_box = {
		type = "fixed",
...
lib_shapes.register_shape("wall_block_100_height_050_width", {
	description = "Column Base Half Height Full Width", 
	shape_type = "basic",
	node_box = {
		type = "fixed",
...
lib_shapes.register_shape("wall_brick_100_height_050_width", {
	description = "Column Base Half Height Full Width", 
	shape_type = "basic",
	node_box = {
		type = "fixed",
